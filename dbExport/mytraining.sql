...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=latin1 COMMENT='activity is a father of all trainig.';
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `mytraining`.`delete_activity` BEFORE DELETE ON mytraining.activity FOR EACH ROW
begin
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='on 100 g of food';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `food` VALUES (1,'Red Bull',45,0,11,0,8),(2,'Kellogs Special K Ciocholate',404,8,75,7,3),(3,'Drained tuna',198,29,0,8,4),(4,'Pasta di semola',374,13,75,2,3),(5,'Gallette di riso',389,8,80,2,3),(6,'Simmenthal',62,11,0,2,2),(7,'Roasted chicken breast',165,31,0,4,2);
...
INSERT INTO `food_type` VALUES (1,'dairy product'),(2,'meat'),(3,'cereals and tubers'),(4,'fish'),(5,'fruit'),(6,'vegetables'),(7,'lipids'),(8,'beverages');
...
INSERT INTO `running_path` VALUES (1,'SPG(fiume)-LAPPANO(bridge)',12,'this path is an only lap'),(2,'SPG(fiume)-LAPPANO(paolo marra)',9,NULL),(3,'SPG(fiume)-FONTANA_LAPPANO',9,'only lap');
...
INSERT INTO `running_training` VALUES (1,2,156,46,2,2),(2,2,156,50,8,2),(3,3,156,50,18,2),(4,2,156,50,20,2),(5,3,156,50,22,2),(6,3,156,50,26,2),(7,2,156,55,32,2),(8,2,156,55,46,2),(9,3,150,55,49,2),(10,3,158,41,51,2),(11,3,158,43,59,2),(14,2,155,50,75,2);
...
INSERT INTO `weather` VALUES (1,'rain',10),(2,'sun',10),(3,'sun',20),(4,'sun',30),(5,'sun',5),(6,'rain',5);
...
-- Dump completed on 2014-01-26 20:50:52
